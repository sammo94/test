...
<script>
	$(document).ready(function() {
		...
		$("#multiId").bind('click', function(ev) {
...
<%
	...
	int multicount = (int) request.getAttribute("multi");	
...
<body class="body">
	<div class="w3-container" align="center">
			...
			<div style="margin-top: 30px; padding: 0px 10px 0px 10px; font-family: arial;" align="center" >
				<p><font size="4"><strong> <%=desc1%></strong></p>
			</div>
			
			<div style="margin-top:35px; padding: 0px 10px 0px 10px; font-family: arial;" align="center">
					...
					<td align="center" valign="top" width="100%"
						...
						<div id="jSecureImgId" align="center">
							<div id="jSecureImgContainer" align="center">
								...
								<img src="data:image/png;base64,<%=img2%>" id="share2"
									class="jSecureOverlay">
							</div>
						</div>
						<br>
			...
			<%if(multicount > 1) { %>
			<div id="multiId" align="center">
			<button>Use Primary Mobile Number</button>
			</div>
			<%} %>
			<form name="multiform" id="multiform" action="/Ashield/multi-flow"
				method="post">
				<input type="hidden" name="transID" value="<%=optxnid%>" />
			</form>
			
			<div id="i" align=center style="margin-top:30px;"><img src="<%=imgstr%>" 
