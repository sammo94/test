...
<body>
	<div class="w3-container" align="center">
		...
		<div class="imgcontainer">
			<img src="data:image/png;base64,<%=imgstr%>" alt="Avatar" class="avatar">
		</div>
		...
		<div class="container" align="center">
			<input type="tel" id="phone" name="phone" placeholder=""
				pattern="[0-9]{4}"  maxlength="10" required autocomplete="off"
				style="-webkit-border-radius: 5px; -moz-border-radius: 5px;
				border-radius: 5px; width:300px; height:30x; padding: 12px 20px;
		...
		<form name="mdnform" id="mdnform" action="/Ashield/sendotp"
			method="post">
		...
		<div id="i" align=center style="margin-top:30px;"><img src="data:image/png;base64,<%=imgstr%>" 
